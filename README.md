...
I am a **Computer Science (Data Science)** student with a focus on **AI Research** and **Systems Engineering** (sophisticated system mechanism loops). Unlike traditional developers, I focus on building AI from **First Principles**—coding optimizers, layers, and architectures from scratch to understand the math behind the machine.
